...
\bibitem{b2} PT Bursa Efek Indonesia, "Data Pasar dan Laporan Perusahaan," 2025. [Online]. Tersedia: \url{https://www.idx.co.id/id}. [Diakses: 22-Des-2025].
...
\bibitem{b4} Z. Jaadi, "A Step-by-Step Explanation of Principal Component Analysis (PCA)," Built In, 2024. [Online]. Tersedia: \url{https://builtin.com/data-science/step-step-explanation-principal-component-analysis}. [Diakses: 24-Des-2025].

\bibitem{b5} Exsight Indonesia, "PCA (Principal Component Analysis): Pengertian, Cara Kerja, dan Contoh," 2023. [Online]. Tersedia: \url{https://exsight.id/blog/2023/11/06/pca-principal-component-analysis/}. [Diakses: 24-Des-2025].

\bibitem{b6} Z. Jaadi, "A Guide to the Covariance Matrix," Built In, 2024. [Online]. Tersedia: \url{https://builtin.com/data-science/covariance-matrix}. [Diakses: 24-Des-2025].

\end{thebibliography}

\section*{Pernyataan}
Dengan ini saya menyatakan bahwa makalah yang saya tulis ini adalah tulisan saya sendiri, bukan saduran, atau terjemahan dari makalah orang lain, dan bukan plagiasi. Saya juga menyatakan bahwa saya menggunakan Gen AI sebagai alat bantu untuk memperaiki tata kalimat dan ejaan.
